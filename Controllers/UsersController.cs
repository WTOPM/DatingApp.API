    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> UnlikeUser(int id, int recipientId)
        {
            if (id != int.Parse(User.FindFirst(ClaimTypes.NameIdentifier).Value))
                ...
                var unlike = await _repo.GetLike(id, recipientId);
        ...
        [HttpPost("{id}/checklike/{recipientId}")]
        public async Task<IActionResult> CheckLikeUser(int id, int recipientId)
        {
            if (id != int.Parse(User.FindFirst(ClaimTypes.NameIdentifier).Value))
                return Unauthorized();
                bool result = false;
